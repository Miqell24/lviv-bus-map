...
Lviv: 2 x 2 road tiles plus the tram network. The trolleybuses ride the road
graph, as everywhere in this family.
"""
import json, os, re, sys
import osmium

ROOT = os.path.join(os.path.dirname(__file__), '..')
PBFS = [os.path.join(ROOT, 'data', 'ukraine-latest.osm.pbf')]

# must match pipeline/download.sh
S, N, W, E = 49.73, 50.02, 23.82, 24.21
RAIL_BOX = (49.75, 23.84, 50.0, 24.19)
...
rail_file = os.path.join(ROOT, 'data/osm/lviv-rail.json')
...
GEN = 'pbf-tiles.py (Geofabrik ukraine)'
